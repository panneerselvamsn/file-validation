...
public class FileUploadService {
	...
	public List<RecordDesc> validateInput(MultipartFile file, String fileType) throws IOException {
		...
		// Identifying Unique reference number and adding those records in a
		// HashMap
	...
	public List<RecordDesc> getRecords() {
		RecordDesc recordDescOne = new RecordDesc();
		recordDescOne.setAccountNumber("111");
		recordDescOne.setDescription("Desc");
		recordDescOne.setEndBalance(12);
		recordDescOne.setMutation(12);
		recordDescOne.setReference(1122);
		recordDescOne.setStartBalance(12);
		recordDescOne.setValid(true);

		RecordDesc recordDescTwo = new RecordDesc();
		recordDescTwo.setAccountNumber("112");
		recordDescTwo.setDescription("Desc");
		recordDescTwo.setEndBalance(11);
		recordDescTwo.setMutation(11);
		recordDescTwo.setReference(1121);
		recordDescTwo.setStartBalance(11);
		recordDescTwo.setValid(true);

		List<RecordDesc> recordList = new ArrayList<>();
		recordList.add(recordDescOne);
		recordList.add(recordDescTwo);
